...
// Source: broozkan/postapi/handlers (interfaces: PostServiceInterface)
...
func (m *MockPostServiceInterface) CreatePost(arg0 context.Context, arg1 *models.Post) (*models.Post, error) {
	m.ctrl.T.Helper()
